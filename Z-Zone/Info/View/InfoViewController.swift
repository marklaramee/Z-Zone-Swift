...
class InfoViewController: UIViewController {
    ...
    It's not hard for a couple of contacts; but, it can get tedious if you have many contacts to add to or remove from your Z-Zone. The Z-Zone app makes this easy.
